...
export default function WorldClockRow({label, timeZone, uiScale}: WorldClockRowProps) {
  return (
    <box orientation={Gtk.Orientation.HORIZONTAL} halign={Gtk.Align.FILL}>
      <box orientation={Gtk.Orientation.VERTICAL} spacing={uiScale.size(2)} hexpand>
      ...
      <box orientation={Gtk.Orientation.VERTICAL} spacing={uiScale.size(2)} halign={Gtk.Align.END}>
        <label
