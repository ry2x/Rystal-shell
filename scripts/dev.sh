...
export RYPRLAND_CACHE_DIR="${RYPRLAND_CACHE_DIR:-$dev_dir/cache}"
export RYPRLAND_STATE_DIR="${RYPRLAND_STATE_DIR:-$dev_dir/state}"
export RYPRLAND_RUNTIME_DIR="${RYPRLAND_RUNTIME_DIR:-$dev_dir/runtime}"

mkdir -p \
    "$RYSTAL_SHELL_CONFIG_DIR" \
    "$RYPRLAND_CACHE_DIR" \
    "$RYPRLAND_STATE_DIR" \
    "$RYPRLAND_RUNTIME_DIR"
